...
BIST_TICKERS = [
    ...
    "AKENR", "AKFGY", "AKFYE", "AKGRT", "AKSA", "AKSEN", "ALARK", "ALBRK", "ALVES", "ARCLK", "ASELS", "ASTOR", 
    "BIMAS", "BRSAN", "CANTE", "CATES", "DOAS", "EKGYO", "ENJSA", "EREGL", "ESEN", "FROTO", "GARAN", "GUBRF", 
    "HEKTS", "ISCTR", "KARDMD", "KAYSE", "KCHOL", "KOZAL", "KONTR", "MERCN", "MIATK", "ODAS", "PETKM", "PGSUS", 
